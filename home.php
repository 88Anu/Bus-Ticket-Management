   ...
   <!-- <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css">-->
    ...
    <style type="text/css">
      ...
      body{
           ...
           background-image: url(image/BLDEAS.jpg);
  ...
  <div id="container">
            ...
            <?php include("nav.php");
             ?>
                  ...
                  <h1 class="home_details">Travel.Anytime.<br><font class="font">Anywhere..</font>

                  <br>

                      <!-- <button class="btnHome">SIGN UP NOW</a></button> -->
                       <button class="btnHome"><a href="signUp.php">SIGN UP NOW</a></button>
                       <!-- <h1 class="home_details">Travel.Anytime.<br><font class="font">Anywhere..</font> -->
